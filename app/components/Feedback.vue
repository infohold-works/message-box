<script>
  import { addFeedback } from '../vuex/actions';
  ...
  export default {
    ...
    methods: {
      ok() {
        ...
        this.addFeedback(this.user.userid, this.feedbackDesc);
        this.$dispatch('sendback');
      },
      cancel() {
        this.$emit('cancel');
        this.show = false;
      ...
      <div class="modal-dialog" :class="modalClass" v-el:dialog>
        <div class="modal-content">
          ...
          <div class="modal-body">
            <label for="feedbackContent" class="title"><span><strong>您可以直接给我们发送反馈</strong></span></label>
            <textarea id="feedbackContent" name="content" rows="8" cols="40" class="form-control" placeholder="问题描述" v-model="feedbackDesc"></textarea>
          </div>
          <!--Footer-->
